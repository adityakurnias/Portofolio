<template>
    <div class="relative min-h-screen overflow-hidden bg-black">
        <div class="absolute inset-0 z-0">
            <ClientOnly>
                <TresCanvas alpha>
                    <TresPerspectiveCamera :position="[0, 0, 4]" :look-at="[0, 0, 0]" />
        ...
        <div class="relative z-10 pointer-events-none min-h-screen flex flex-col">
                ...
                <div class="max-w-4xl">
                    ...
                    <div class="hero-btn opacity-0 mt-5 pointer-events-auto w-fit">
                        <a href="#about" @click="scrollToSection($event, '#about')"
                            ...
                            <span
                                class="w-12 h-px bg-white group-hover:w-28 duration-500 ease-in-out transition-all"></span>
                            Begin Voyage
                        </a>
                    </div>
                </div>
...
onMounted(() => {
    ...
    tl.to(".hero-text", { opacity: 1, y: 0, duration: 2 })
        .to(".hero-btn", { opacity: 1, duration: 1 }, "-=1");
});
</script>
