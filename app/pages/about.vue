  ...
  <div ref="mainContainer"
    ...
    <section class="pt-32 px-6 lg:px-16 mb-20">
      <div class="border-b border-neutral-800 pb-12">
        <span class="block text-xs tracking-[0.2em] text-neutral-500 mb-6 reveal-item">
          01.1 - MORE ABOUT ME
        </span>
        <h1 class="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-[0.9]">
          <div class="overflow-hidden pb-4">
            <span class="block reveal-text">Crafting</span>
          </div>
          <div class="overflow-hidden pb-4">
            <span class="block reveal-text text-neutral-500">Digital Reality.</span>
          </div>
        </h1>
      </div>
    </section>

    <section class="px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mb-32">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center space-y-8">
        <h3 class="text-2xl md:text-3xl font-light leading-snug reveal-bio opacity-0 translate-y-8">
          I'm a
        ...
        <div class="space-y-6 text-neutral-400 text-base md:text-lg leading-relaxed reveal-bio opacity-0 translate-y-8">
          <p>
        ...
        <div class="pt-8 reveal-bio opacity-0 translate-y-8">
          ...
          <button
            ...
            Download Resume
            <span
              class="block w-2 h-2 bg-white rounded-full group-hover:scale-150 transition-transform duration-300"></span>
          </button>
        </div>
      </div>
    </section>
    ...
    <section class="px-6 lg:px-16 pb-32">
      <div class="flex items-end justify-between mb-12">
        ...
        <span class="hidden md:block text-xs font-mono text-neutral-500 reveal-stack">(WHAT I DO BEST)</span>
      </div>
      ...
      <div class="border-t border-neutral-800">
        <div v-for="(skill, i) in skills" :key="i"
          ...
          <div class="flex items-center gap-8">
            <span class="text-xs font-mono text-neutral-600 group-hover:text-white transition-colors">0{{ i + 1 }}</span>
            <h4 class="text-2xl md:text-4xl font-medium text-neutral-300 group-hover:text-white transition-colors">
              {{ skill.name }}
            </h4>
          </div>
          <div class="mt-4 md:mt-0 flex items-center gap-4 md:gap-12">
            <p class="text-sm text-neutral-500 group-hover:text-neutral-300 transition-colors">
              {{ skill.items }}
            </p>
            <span
...
const skills: { name: string; items: string }[] = [
  { name: "Programming Language", items: "JavaScript, TypeScript, PHP, Ruby" },
  { name: "Frontend Development", items: "Vue, Nuxt, React" },
  { name: "Backend Development", items: "Laravel, Hono, Nuxt" },
  { name: "UI/UX Design", items: "Figma, Penpot" },
];
