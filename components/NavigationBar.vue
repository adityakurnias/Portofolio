<template>
  <nav class="fixed top-0 right-0 w-1 break-words leading-none p-8 z-10">
    <ul class="text-xl font-semibold" v-auto-animate>
      <li
      ...
      >
        <NuxtLink
          to="mailto:adityakurniasaputra903@gmail.com"
